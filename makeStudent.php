...
<body>
<div class="container">
	<center><h2>Make Student</h2></center><br><br>	
...
try {
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
     ...
     if (empty($studentid) or empty($firstname) or empty($lastname) or empty($majorcode) or empty($telephone)) {
     	echo '<p> **** don\'t null **** </p>';
     }
     else {
     	$sql = "INSERT INTO Student (StdID, FirstName, LastName, MajorCode, Telephone) VALUES ('$studentid', '$firstname', '$lastname', '$majorcode', '$telephone')";
		$qry = $conn -> query($sql);
